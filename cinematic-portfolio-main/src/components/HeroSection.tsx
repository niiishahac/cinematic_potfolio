          ...
          >
            ...
            <motion.div variants={fadeUpVariants} className="mb-4">
              <p
                ...
                style={{ fontFamily: "'Montserrat', sans-serif" }}
              >
                FULL STACK DEVELOPER <span className="text-[#8C6D4F] mx-1">•</span> DATA SCIENCE <span className="text-[#8C6D4F] mx-1">•</span> ANALYTICS
              </p>
            </motion.div>
            ...
            >
              <p>
                I'm a Computer Science (Data Science) student building full-stack platforms and data-driven tools.
                <br />
                From role-based dashboards to ML-powered analytics, I turn raw data and ideas into working systems.
              </p>
            </motion.div>
