...
const journey: RouteStop[] = [
  {
    id: '01',
    year: '2025',
    title: 'COORDINATOR, STUDENT CAREER CELL',
    organization: 'ABES ENGINEERING COLLEGE',
    description: 'Coordinated placement drives and industry outreach, managing scheduling and on-ground execution across multiple teams and stakeholders.',
  },
  {
    id: '02',
    year: '2026 MILESTONE',
    title: 'TOP 35 NATIONAL TEAM (ZONAL)',
    organization: 'WOMEN WHO MASTER HACKATHON 2026',
    description: 'Secured a position among the Top 35 teams at the Zonal Level of the Women Who Master Hackathon 2026.',
  },
  {
    id: '03',
    year: '2024',
    title: 'TOP 5 HACKATHON FINISH',
    organization: "PRAGYAN'24, ABES ENGINEERING COLLEGE",
    description: 'Ranked Top 5 in the PRAGYAN\'24 Hackathon, competing across problem-solving and rapid prototyping rounds.',
  },
  {
    id: '04',
    year: '2023 - 2027',
    ...
    organization: 'ABES ENGINEERING COLLEGE',
    description: 'Building a strong foundation in DSA, OOP, DBMS, and OS. Solved 250+ algorithm challenges across LeetCode, CodeChef, and GeeksforGeeks.',
  },
  {
    id: '05',
    year: '2020 - 2022',
    title: 'HIGHER SECONDARY (CBSE)',
    organization: 'KENDRIYA VIDYALAYA, UPPER SHILLONG',
    description: 'Completed Class XII with 83.2% aggregate, following Class X at Kendriya Vidyalaya No. 1, Tezpur with 80.6%.',
  },
];
