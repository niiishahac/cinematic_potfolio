          ...
          <div className="lg:col-span-5 flex flex-col justify-between">
            <div>
              ...
              <p
                ...
                style={{ fontFamily: "'Montserrat', sans-serif" }}
              >
                Have an opportunity, a project idea, or a collaborative inquiry? Send a direct dispatch below.
              </p>

              {/* Direct Contact Links */}
              <div className="mt-8 space-y-2.5">
                <a
                  href="mailto:nisha.23b15410176@abes.ac.in"
                  className="block text-xs text-[#C4B5A5] hover:text-[#D4AF37] transition-colors"
                  style={{ fontFamily: "'Montserrat', sans-serif" }}
                >
                  nisha.23b15410176@abes.ac.in
                </a>
                <a
                  href="tel:+916001342063"
                  className="block text-xs text-[#C4B5A5] hover:text-[#D4AF37] transition-colors"
                  style={{ fontFamily: "'Montserrat', sans-serif" }}
                >
                  +91 6001342063
                </a>
                <span className="block text-xs text-[#8C6D4F]">
                  Ghaziabad, Uttar Pradesh
                </span>

                <div className="flex flex-wrap gap-x-5 gap-y-2 pt-3 text-[10px] font-medium tracking-[0.18em] uppercase">
                  <a href="https://github.com/niiishahac" target="_blank" rel="noopener noreferrer" className="text-[#A8988B] hover:text-[#D4AF37] transition-colors">GitHub</a>
                  <a href="https://www.linkedin.com/in/nisha-kumari-b62a9432a/" target="_blank" rel="noopener noreferrer" className="text-[#A8988B] hover:text-[#D4AF37] transition-colors">LinkedIn</a>
                  <a href="https://leetcode.com/u/Nishakumari123/" target="_blank" rel="noopener noreferrer" className="text-[#A8988B] hover:text-[#D4AF37] transition-colors">LeetCode</a>
                  <a href="https://www.codechef.com/users/worth_fire_56" target="_blank" rel="noopener noreferrer" className="text-[#A8988B] hover:text-[#D4AF37] transition-colors">CodeChef</a>
                </div>
              </div>
            </div>
          </div>
