...
const projects: Project[] = [
  {
    number: '01',
    title: 'NEXUS IQ',
    category: 'AI / INDUSTRIAL MONITORING PLATFORM',
    description:
      'A role-based industrial intelligence platform built for Operator, Engineer, and Manager dashboards with dedicated permissions. Implements real-time Z-score and slope-based anomaly detection over a simulated sensor pipeline to surface critical events.',
    githubUrl: 'https://github.com/niiishahac',
    tech: ['FastAPI', 'Python', 'SQLite', 'JavaScript'],
    metrics: [
      { label: 'ROLES', value: 'Operator / Engineer / Manager' },
      { label: 'DETECTION', value: 'Z-Score & Slope Analysis' },
      { label: 'PIPELINE', value: 'Simulated Sensor Feed' },
    ],
  },
  {
    number: '02',
    ...
    description:
      'An interactive Power BI dashboard for trend analysis and data visualization, with dynamic slicers and drill-through functionality supporting detailed analysis across multiple dimensions to drive data-driven decisions.',
    githubUrl: 'https://github.com/niiishahac',
    tech: ['Power BI', 'DAX', 'Data Visualization'],
    metrics: [
      { label: 'TOOLS', value: 'Power BI + DAX' },
      { label: 'FEATURES', value: 'Slicers & Drill-Through' },
      { label: 'OUTPUT', value: 'Executive Reports' },
    ],
  },
];
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        ...
        >
          ...
          <p
            ...
            style={{ fontFamily: "'Montserrat', sans-serif" }}
          >
            Scroll down to unfold each project card. From industrial monitoring to BI dashboards, each was built to solve a real problem.
          </p>
        </motion.div>
