        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.p
              ...
              style={{ fontFamily: "'Montserrat', sans-serif" }}
            >
              I'm <span className="text-[#F3DBB3] font-medium">Nisha Kumari</span>, a Computer Science (Data Science) undergraduate specializing in full-stack development, backend systems, and data analytics. With a strong foundation in DSA and hands-on experience building role-based platforms and BI dashboards, I turn complex problems into clean, working products.
            </motion.p>
