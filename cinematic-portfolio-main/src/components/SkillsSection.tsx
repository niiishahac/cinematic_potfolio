...
const bentoCategories = [
  {
    ...
    badge: 'CORE PILLAR',
    items: ['React.js', 'Node.js', 'JavaScript', 'HTML5', 'CSS3', 'REST APIs'],
    description: 'Building responsive web applications end-to-end, from React interfaces to Node.js backends and REST API integrations.',
    stat: 'END TO END',
  ...
  },
  {
    ...
    description: 'Designing relational and document schemas, writing efficient SQL, and working across both SQL and NoSQL data stores.',
    stat: 'SQL & NOSQL',
  ...
  },
  {
    ...
    badge: 'INSIGHTS',
    items: ['Power BI', 'DAX', 'Power Query', 'Data Cleaning'],
    description: 'Building interactive dashboards with dynamic slicers and drill-through analysis to support data-driven decisions.',
    stat: 'BI DASHBOARDS',
    colSpan: 'lg:col-span-5',
  },
  {
    ...
    badge: 'FOUNDATION',
    items: ['Java', 'Python', 'DSA', 'OOP', 'DBMS', 'Operating Systems'],
    description: '250+ algorithm problems solved across LeetCode, CodeChef, and GeeksforGeeks, backed by a strong core CS foundation.',
    stat: '250+ SOLVED',
    colSpan: 'lg:col-span-7',
  },
];
